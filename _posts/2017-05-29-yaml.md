...
* Không nên sử dụng tùy tiện Editor để hạn chế phát sinh lỗi, bạn có thể sử dụng các Editor thường dùng khi viết code như [Atom](https://atom.io/), [Sublime Text 3](https://www.sublimetext.com/3) hay [Notepad++](https://notepad-plus-plus.org/download/v7.4.1.html). Hoặc nếu không bạn cũng có thể sử dụng 1 số trình soạn thảo online sau đây :
...
Chúng ta thực hiện bằng cách đặt đoạn dữ liệu được viết bằng YAML giữa 3 dấu gạch đầu dòng `---`, phía trên cùng đoạn văn bản được viết bằng Markdown. Đây là đoạn đầu trong bài post [YAML cơ bản]() của mình: 
